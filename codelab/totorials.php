...
<div class="row" style="padding:70px 16px">
  <h3 class="w3-center" ><b>Tutorials</b></h3>
  <p class="w3-center w3-large">Study tutorials that will guide you </p><br>
  ...
  $query = " SELECT `topic`, `link`, `description` FROM `tutorials` order by id ASC ";
  ...
  if($num > 0){
    ...
    <div id="rcorners" class="card"> -->
    <div class="column">
      <div class="card">
      <h2><?php echo $product['topic'];  ?></h2>
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" src="<?php echo $product['link'];  ?>" allowfullscreen></iframe>
    </div>
      <div class="card-body">
